...
```{r Frequency of protective behaviour: Random effects plot, dpi=600, echo=FALSE, fig.show="asis", warning=FALSE, message=FALSE}
...
ggsave("plotcmm.ranef.png", plot = last_plot(), dpi = "retina", width = 10, height = 6, units = "in")
