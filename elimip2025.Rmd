---
title: "Mosquito-borne disease and protective behavior in metropolitan France: a pre-registered discrete-choice experiment"
...
df$age_group2 <- case_when(
  df$age_group %in% c("18 to 29", "30 to 39") ~ "18 to 39",
  df$age_group %in% c("40 to 49", "50 to 59") ~ "40 to 59",
  df$age_group %in% c("60 to 69", "70 to 79") ~ "60 to 79",
  TRUE ~ NA_character_)
...
## 4.1. Interactive map
```{r Interactive map: Match geometry}
...
View(fr_check) #checked
```

```{r Interactive map: Data for maps}
##Departement
...
#map_fr <- map_fr %>% dplyr::select(-count_prev_avg.x,-count_prev_avg.y)
```

```{r Interactive map: Map execute, warning=FALSE, out.width = '100%'}
...
#add AVG COUNT polygons
  addPolygons(
    ...
    dashArray = "3",
    fillOpacity = 0.7,
    label = ~paste0(nom, " (n=", sample_size, ") - Count of protective behaviours (average): ",
      formatC(count_prev_avg, big.mark = "'")),
      labelOptions = labelOptions(
      style = list("font-weight" = "normal", padding = "3px 8px"),
      textsize = "15px",
      direction = "auto"),
    group = "Department:Count of protective behaviours (average)"
  ) %>%
  addLegend(
    pal = pal1,
    ...
    title = "Count of protective behaviours (average)",
...
#add MEDIAN COUNT polygons
  addPolygons(
    ...
    dashArray = "3",
    fillOpacity = 0.7,
    label = ~paste0(nom, " (n=", sample_size, ") - Count of protective behaviours: ",
      formatC(count_prev_median, big.mark = "'")),
      labelOptions = labelOptions(
      style = list("font-weight" = "normal", padding = "3px 8px"),
      textsize = "15px",
      direction = "auto"),
    group = "Department: Count of protective behaviours (median)"
  ) %>%
#add Count prev avg per region  
  addPolygons(
    ...
    label = ~paste0(nom, " (n=", sample_size, ") - Count of protective behaviours (average): ",
      ...
      textsize = "15px",
      direction = "auto"),
    group = "Region: Count of protective behaviours (average)"
  ) %>%
#add Count prev median per region  
  addPolygons(
    ...
    dashArray = "3",
    fillOpacity = 0.7,
    label = ~paste0(nom, " (n=", sample_size, ") - Count of protective behaviours (median): ",
      formatC(count_prev_median_region, big.mark = "'")),
      labelOptions = labelOptions(
      style = list("font-weight" = "normal", padding = "3px 8px"),
      textsize = "15px",
      direction = "auto"),
    group = "Region: Count of protective behaviours (median)"
  ) %>%
...
#add layer controls
  addLayersControl(
    overlayGroups = c("Department:Count of protective behaviours (average)","Department: Count of protective behaviours (median)", "Region: Count of protective behaviours (average)", "Region: Count of protective behaviours (median)","Region: High frequency of protective behaviour (%)"),
    position = "topleft",
